...
\begin{DoxyCompactList}\small\item\em \hyperlink{classAlignBin}{Align\+Bin} class contains all the variables and functions for alligning bin task. \end{DoxyCompactList}\end{DoxyCompactItemize}
