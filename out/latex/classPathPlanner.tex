...
parameterised constructor ; creates all tasks related objects , initializes all subscribers and publishers , bool parameters , etc. 

S\+U\+B\+S\+C\+R\+I\+B\+ED T\+O\+P\+I\+CS \+: /front\+\_\+camera/image\+\_\+rect\+\_\+color /bottom\+\_\+camera/image\+\_\+rect\+\_\+color /vectornav

P\+U\+B\+L\+I\+S\+H\+ED T\+O\+P\+I\+CS \+: /front\+\_\+camera\+\_\+debug /bottom\+\_\+camera/debug /setpoints /actuator/ball\+\_\+drop /breach\+\_\+command /actuator/picker\+\_\+ascend /actuator/picker\+\_\+descend


\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em \+\_\+nh} & ros Node\+Handle\\
\hline
\mbox{\tt in}  & {\em int(1)} & stores next sway mode\\
\hline
\mbox{\tt in}  & {\em int(2)} & stores sway range \\
\hline
\end{DoxyParams}
...
function controls the ball drop mechanism 
...
function controls the ball pick mechanism 
...
function receives the bottom camera feed of the auv , identifies all tasks related objects and debugs it accordingly ; publishes through bottom\+Debug\+Pub 
...
function finds required setpoints for detecting the gate 
...
\hline
\mbox{\tt in}  & {\em Time\+Point(2)} & start time of task \\
\hline
\end{DoxyParams}
...
function receives the front camera feed of the auv , identifies all tasks related objects and debugs it accordingly ; publishes through front\+Debug\+Pub 
...
function publishes setpoints (output values) till the gate is detected 
...
function receives vectornav data to get the current yaw value and stores it 
